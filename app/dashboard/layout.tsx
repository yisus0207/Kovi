...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const navItems = [
    { name: 'Dashboard', href: '/dashboard', icon: <Icons.Dashboard />, short: 'Home' },
    { name: 'Chat', href: '/dashboard/inbox', icon: <Icons.Message />, short: 'Chat' },
    ...
    { name: 'Aura IA', href: '/dashboard/aura', icon: <Icons.Star />, short: 'IA' },
    { name: 'Config', href: '/dashboard/settings', icon: <Icons.Settings />, short: 'Config' },
  ]
